# 🔴 RedTiger Stealer --- De-obfuscation & Malware Analysis Report [source](https://github.com/Blackeige/ZeroTrace-Tools/issues/1)

- [Wontfallo](https://github.com/Wontfallo) - [on Apr 2, 2026](https://github.com/Blackeige/ZeroTrace-Tools/issues/1#issue-4190905069)
...
```mermaid
graph TD
    A["main.py<br/>Entry Point"] --> B["Platform Check<br/>Supported OS"]
    B --> C["System Setup<br/>Config, Paths, Dependencies"]
    C --> D{"Run Modules"}
    D --> E["System Info<br/>Hardware / Software Inventory"]
    D --> F["Logging<br/>Events / Diagnostics"]
    D --> G["Screenshots<br/>Optional Capture"]
    D --> H["Startup Tasks<br/>Optional Persistence"]
    E --> I["Output Sink<br/>Local File / API"]
    F --> I
    G --> I
    H --> I
```
